			...
			<div class="card full-height">
				<div class="card-header">
					<div class="card-head-row">
						<div class="card-title">Form Edit Artikel <i>"{{$artikel->judul}}"</i></div>
                ...
                <div class="form-group">
                    ...
                    <br>
                    <label for="gambarnow">Gambar saat ini:</label><br>
                    <img src=" {{asset('uploads/'. $artikel->gambar_artikel)}}" width="100">
                </div>
                <div class="form-group">
				    <label for="dokumen">Dokumen Artikel</label>
			        <input type="file" name="dokumen" class="form-control" value="{{$artikel->dokumen}}"> 
                </div>
                <div class="form-group">
